            ...
            <div className='order-summary-wrap'>
                <div className='summary-button' onClick={() => setSummaryProduct(!summaryProduct)}>
                    <div className='title-container quicksand'>
                        ...
                        {summaryProduct ? ( <i class="bi bi-chevron-up downchevron"></i> ) : ( <i class="bi bi-chevron-down downchevron"></i> ) }
                    </div>
                                    ...
                                    return (
                                        <div className='item' key={index}>
                                            ...
                                            <div className='item-info'>
                                                <h6 class="quicksand title">
                                                    Insects & Mosquitos Go Away Kit for Babies with pleasant rose smell
                                                </h6>
                                                <h6 class="quicksand quantity">
                                                    Quantity : 3
                                                </h6>
                                                <h6 class="quicksand price">
                                                    price : 172.05
                                                </h6>
                                            </div>
                                        </div>
